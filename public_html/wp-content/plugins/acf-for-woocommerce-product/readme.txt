...
Tags: acf,woocommerce,custom,field,Advanced Custom Fields
...
Upload ‘afwp’ to the ‘/wp-content/plugins/’ directory
...
Q. Is this plugin displays all field types of ACF free version?
Yes.

== Screenshots ==
1. ACF fields on front end
2. ACF Fields on admin side
3. ACF Fields in custom field

== Changelog ==
1.1
Fixed: empty lines output on the product page

1.0 Initial Version

== Upgrade Notice ==
Not Upgrade required since it is initial release.